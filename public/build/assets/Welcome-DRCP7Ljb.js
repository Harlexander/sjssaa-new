...
`;function lo(t,e,n){switch(n){case"bottom-left":return e?Ws:Ls;case"bottom-right":return e?Qs:Ps;case"down":return t?e?to:zs:e?Zs:Rs;case"left":return t?e?no:Fs:e?eo:Qe;case"right":return t?e?so:Vs:e?ro:Ds;case"top-left":return e?oo:Bs;case"top-right":return e?ao:_s;case"up":return t?e?co:Xs:e?io:Ys;default:return e?Ks:Ts}}const lt=t=>{const{big:e=!1,direction:n,reverse:r=!1,...s}=t,o=N.useMemo(()=>lo(e,r,n),[e,n,r]);return B(Ze,{keyframes:o,...s})};b`
  from {
